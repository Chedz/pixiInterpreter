...
async function lazyLoadResources(taskUid: string, resourcesObject: any, appObj: any) {
...
let manifestString = {
    ...
    await Assets.init({ manifest: manifestString });

    // Bundles can be loaded in the background too!
    // Assets.backgroundLoadBundle(['load-screen', 'game-screen']);
    Assets.backgroundLoadBundle(["G1-052-3-e5"]);
